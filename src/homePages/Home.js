...
<h1 class="mb-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl"><span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">Titulo</span> Principal</h1>
<p class="text-lg font-normal text-white lg:text-xl ">Here at Flowbite we focus on markets where technology, innovation, and capital can unlock long-term value and drive economic growth.</p>
  ...
  <div><div className='max-w-[1100px] h-[650px] w-1100px m-auto py-6 px-4 relative group '>
      <div
